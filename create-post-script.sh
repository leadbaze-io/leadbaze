...
echo "📝 Criando script para adicionar post à fila no Servla..."

# Criar o script no Servla
cat > add-post-to-queue.sh << 'SCRIPT_EOF'
#!/bin/bash
...
chmod +x add-post-to-queue.sh

echo "✅ Script criado com sucesso!"
echo "📁 Arquivo: add-post-to-queue.sh"
echo "🚀 Para executar: ./add-post-to-queue.sh"
