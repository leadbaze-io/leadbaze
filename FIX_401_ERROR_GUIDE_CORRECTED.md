# 🔧 Guia para Corrigir Erro 401 - VERSÃO CORRIGIDA
...
**Problema anterior**: `ERROR: 42P13: input parameters after one with a default value must also have defaults`

**Solução**: Reorganizei os parâmetros para que todos os obrigatórios venham primeiro, e todos os opcionais (com DEFAULT) venham depois.

### **Ordem Correta:**
1. **Parâmetros obrigatórios** (sem DEFAULT)
2. **Parâmetros opcionais** (com DEFAULT)
