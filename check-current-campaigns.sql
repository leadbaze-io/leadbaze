-- Script para verificar o estado atual das campanhas criadas
...
-- 4. Verificar se os contadores estão sendo atualizados automaticamente
-- Testar a função update_campaign_counters manualmente
DO $$
DECLARE
...
-- 8. Testar inserção de dados relacionados para ver se os contadores são atualizados
