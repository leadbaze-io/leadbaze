-- =====================================================
-- CRIAÇÃO FINAL DE DADOS DE TESTE PARA PERFECT PAY
-- =====================================================
...
-- 2. Criar perfil do usuário de teste com TODOS os campos obrigatórios
INSERT INTO user_profiles (
    ...
    'João Silva Teste',
    'joao.teste@email.com',
    '11999999999', -- Telefone obrigatório
    'Rua das Flores', -- Rua obrigatória
    '123', -- Número obrigatório
    'Centro', -- Bairro obrigatório
    'São Paulo', -- Cidade obrigatória
    'SP', -- Estado obrigatório
    '01234567', -- CEP obrigatório
    NOW(),
    NOW()
) ON CONFLICT (id) DO NOTHING;
