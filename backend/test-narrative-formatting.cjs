...
console.log('🎨 Testando Formatação Narrativa e Fluida\n');

const supabase = createClient(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
const formatter = new ContentFormatter();

// Exemplo com texto narrativo e fluido
const narrativePost = {
...
async function testNarrativeFormatting() {
    try {
        console.log('📝 Testando formatação narrativa...');
        console.log('Título:', narrativePost.title);
        console.log('Categoria:', narrativePost.category);
        console.log('Tamanho original:', narrativePost.content.length, 'caracteres');
        ...
        console.log('Excerpt:', formatted.excerpt.substring(0, 150) + '...');
        
        console.log('\n🎨 Conteúdo formatado (primeiros 1500 caracteres):');
        console.log(formatted.content.substring(0, 1500) + '...');
        ...
        console.log('\n✅ Post narrativo adicionado à fila com sucesso!');
        console.log('🆔 ID:', data.id);
        console.log('📊 Status: Aguardando processamento');
        console.log('\n🎯 Processe a fila para ver o resultado com texto fluido e narrativo!');
