-- Script completo para limpar e resetar o usuário
-- 1. Ver estado atual
...
-- 2. Cancelar TODAS as assinaturas não-gratuitas
SELECT 'CANCELANDO ASSINATURAS PAGAS...' as step;
...
-- 3. Restaurar plano gratuito para estado original
SELECT 'RESTAURANDO PLANO GRATUITO...' as step;
UPDATE user_subscriptions 
SET 
    status = 'active',
...
-- 6. Testar a função
SELECT 'TESTANDO FUNÇÃO:' as step;
