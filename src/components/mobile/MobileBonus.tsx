  ...
  return (
    <section className="md:hidden py-12 bg-gradient-to-br from-orange-50 to-red-50">
      <div className="max-w-md mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold text-xs shadow-lg mb-4">
            <Gift className="w-3 h-3" />
            Bônus Inclusos
          </div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">
            <span className="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">3 Bônus Exclusivos</span>
          </h2>
        ...
        <motion.div
          ...
          className="mt-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-4 text-white text-center"
        >
