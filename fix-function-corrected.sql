-- Função corrigida para processar fila N8N baseada na estrutura real da tabela
...
BEGIN
    -- Log de início
    RAISE NOTICE '🚀 Iniciando processamento da fila N8N...';
    ...
    LOOP
        BEGIN
            RAISE NOTICE '📝 Processando: % (ID: %)', queue_item.title, queue_item.id;
            ...
            IF category_id IS NULL THEN
                ...
                RAISE NOTICE '✅ Categoria criada: % (ID: %)', queue_item.category, category_id;
            ELSE
                RAISE NOTICE '✅ Categoria encontrada: % (ID: %)', queue_item.category, category_id;
            END IF;
            ...
            RAISE NOTICE '🔗 Slug gerado: %', final_slug;
            ...
            RAISE NOTICE '✅ Post criado com sucesso (ID: %)', new_post_id;
            
            -- Marcar como processado - CORRIGIDO: WHERE clause explícita
            ...
            RAISE NOTICE '✅ Item marcado como processado (ID: %)', queue_item.id;
        ...
        EXCEPTION WHEN OTHERS THEN
            ...
            RAISE NOTICE '❌ Erro ao processar %: %', queue_item.title, SQLERRM;
    ...
    RAISE NOTICE '🏁 Processamento concluído: % processados, % erros', processed_count, error_count;
